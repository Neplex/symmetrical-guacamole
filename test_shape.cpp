...
int main ( void ) {
  ...
  test_shape ( new Shape_Scale ( new Shape_Circle () ,
				 2.2 ) ) ;
  test_shape ( new Shape_Rotate ( new Shape_Square () ,
				  45 ) ) ;
  
  test_shape ( new Shape_Translate ( new Shape_Triangle () ,
				     2 ,
				     1 ) ) ;
  ...
  test_shape ( new Shape_Binary < difference_ > ( new Shape_Scale ( new Shape_Circle () , 2.2 ) ,
						  new Shape_Rotate ( new Shape_Square () , 45 ) ) ) ;
